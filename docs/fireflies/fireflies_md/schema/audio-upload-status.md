...
_Source_: https://docs.fireflies.ai/schema/audio-upload-status
...
Schema for Transcript](/schema/transcript)[## Upload Audio
...
[Suggest edits](https://github.com/firefliesai/public-api-ff/edit/master/docs/schema/audio-upload-status.mdx)[Raise issue](https://github.com/firefliesai/public-api-ff/issues/new?title=Issue on docs&body=Path: /schema/audio-upload-status)

[App Output](/schema/app-output)[Bite](/schema/bite)
