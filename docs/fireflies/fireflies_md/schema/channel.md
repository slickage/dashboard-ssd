...
_Source_: https://docs.fireflies.ai/schema/channel
...
Schema for Transcript](/schema/transcript)[## User Groups

Schema for User Groups](/schema/user-groups)

Was this page helpful?

YesNo

[Suggest edits](https://github.com/firefliesai/public-api-ff/edit/master/docs/schema/channel.mdx)[Raise issue](https://github.com/firefliesai/public-api-ff/issues/new?title=Issue on docs&body=Path: /schema/channel)

[Bite](/schema/bite)[MeetingAnalytics](/schema/meeting-analytics)
