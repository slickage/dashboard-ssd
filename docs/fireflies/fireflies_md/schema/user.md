...
_Source_: https://docs.fireflies.ai/schema/user
...
Schema for User Groups](/schema/user-groups)[## Transcripts

Query transcripts using the API](/graphql-api/query/transcripts)

Was this page helpful?

YesNo

[Suggest edits](https://github.com/firefliesai/public-api-ff/edit/master/docs/schema/user.mdx)[Raise issue](https://github.com/firefliesai/public-api-ff/issues/new?title=Issue on docs&body=Path: /schema/user)

[Transcript](/schema/transcript)[User Groups](/schema/user-groups)
