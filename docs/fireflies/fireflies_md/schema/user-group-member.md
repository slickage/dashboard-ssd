...
_Source_: https://docs.fireflies.ai/schema/user-group-member
...
Schema for User Groups](/schema/user-groups)[## User

Schema for User](/schema/user)

Was this page helpful?

YesNo

[Suggest edits](https://github.com/firefliesai/public-api-ff/edit/master/docs/schema/user-group-member.mdx)[Raise issue](https://github.com/firefliesai/public-api-ff/issues/new?title=Issue on docs&body=Path: /schema/user-group-member)

[User Groups](/schema/user-groups)[GetActiveMeetingsInput](/schema/input/active-meetings-input)
