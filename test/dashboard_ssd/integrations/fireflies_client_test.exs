defmodule DashboardSSD.Integrations.FirefliesClientTest do
  ...
  setup do
    ...
    Application.put_env(:dashboard_ssd, :integrations, Keyword.merge(prev || [], fireflies_api_token: "secret-token"))
  ...
  test "get_transcript_summary maps notes, action_items, bullet_gist" do
    ...
    assert {:ok, %{notes: "Notes here", action_items: ["One", "Two"], bullet_gist: "• One\n• Two"}} =
