...
- **FR-010**: Workspace scaffolding MUST be generated from repository-managed Markdown templates for Drive sections (Contracts, SOWs, Change Orders) and the Notion Project KB hierarchy (Projects KB → Client KB → Project page), allowing admins to choose which sections to provision per client/project.
