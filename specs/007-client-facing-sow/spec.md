...
- **FR-009**: Notion-sourced docs MUST remain view-only for clients; when a file is marked client-visible, the portal should show a rendered preview/download option generated by DashboardSSD rather than linking to Notion directly.
